    ...
    <div>
      <div className='flex lg:flex-row flex-col items-center justify-between lg:h-[500px] w-full font-[Engraver]'>
        <div className='flex justify-center items-center lg:border-r-4 lg:border-b-0 border-b-4 border-black w-full group overflow-hidden duration-500 cursor-pointer h-full'>
          ...
          <span className='absolute text-white text-6xl'>Customized Tattoo</span>
        </div>
        <div className='flex justify-center items-center lg:border-r-4 lg:border-b-0 border-b-4 border-black w-full group overflow-hidden duration-500 cursor-pointer h-full'>
          ...
          <span className='absolute text-white text-6xl text-center'>Minimalist Tattoo</span>
        </div>
        <div className='flex justify-center items-center w-full group overflow-hidden duration-500 cursor-pointer h-full'>
          ...
          <span className='absolute text-white text-6xl'>Realism Tattoo</span>
        </div>
      </div>
    </div>
  )
